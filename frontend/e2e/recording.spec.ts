...
test('revisar, editar y aceptar candidatas con una respuesta simulada',async({page,request})=>{
  ...
  try{
    ...
    const secondClaim={...claim,id:'claim-2',normalized_text:'Saturno tiene anillos.',original_quote:'Saturno tiene anillos',start_ms:1000,end_ms:1500,ambiguity_notes:[],missing_context:[],segments:[{segment_id:'s2',start_ms:1000,end_ms:1500,speaker_id:'b',speaker_name:'Beto',position:0}]}
    const run={id:'run-1',recording_id:recording.id,recording_revision:2,kind:'claim_extraction',status:'completed',provider:'openrouter',model:'modelo-gratuito',prompt_version:'claims-v1',usage:{total_tokens:21},error:null,unreviewed_segment_count:2,created_at:'2026-09-09T00:00:00',completed_at:'2026-09-09T00:00:01',claims:[claim,secondClaim]}
